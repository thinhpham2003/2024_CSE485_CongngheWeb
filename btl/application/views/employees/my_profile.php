...
//}
//$id = $_SESSION['user_id'];
//$user_employee = getEmployeeById($id);
        ...
        <form class="ms-5 me-5">
            ...
            <?php endif; ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="disabledTextInput" class="form-control" value="<?=$user_employee['EmployeeID']?>" readonly>
                </div>
                <div class="mb-3">
                    <label for="disabledTextInput" class="form-label">Tên nhân viên:</label>
                    <input type="text" id="disabledTextInput" class="form-control" value="<?=$user_employee['FullName']?>" readonly>
                </div>
                <div class="mb-3">
                    <label for="disabledTextInput" class="form-label">Địa chỉ:</label>
                    <input type="text" id="disabledTextInput" class="form-control" value="<?=$user_employee['Address']?>" readonly>
                </div>
                <div class="mb-3">
                    <label for="disabledTextInput" class="form-label">Thư điện tử:</label>
                    <input type="text" id="disabledTextInput" class="form-control" value="<?=$user_employee['Email']?>" readonly>
                </div>
                <div class="mb-3">
                    <label for="disabledTextInput" class="form-label">Số điện thoại:</label>
                    <input type="text" id="disabledTextInput" class="form-control" value="<?=$user_employee['MobilePhone']?>" readonly>
                </div>
                <div class="mb-3">
                    <label for="disabledTextInput" class="form-label">Chức vụ:</label>
                    <input type="text" id="disabledTextInput" class="form-control" value="<?=$user_employee['Position']?>" readonly>
                </div>
        </form>
        <a href="edit.php?id=<?=$user_employee['EmployeeID']?>"><button class="btn btn-primary ms-5"><i class="bi bi-pencil"></i>Cập nhập</button></a>
    </main>
    <footer>
