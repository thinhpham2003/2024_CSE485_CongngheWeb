            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" href="departments_regular.php">Danh bạ đơn vị</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../employees/employees_regular.php">Danh bạ nhân viên</a>
                        </li>
                    </ul>
            ...
            <div class="row">
                <div class="col-md">
                    ...
                    <table class="table">
                        ...
                        $totalPages = ceil(count($departments) / $departmentPerPage);
                        $currentPageDepartments = array_slice($departments, ($currentPage - 1) * $departmentPerPage, $departmentPerPage);
                        ?>
                        <?php foreach($currentPageDepartments as $department): ?>
                            <tr>
                    ...
                    <div class="pagination">
                        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                            <?php if ($i == $currentPage): ?>
                                <span class="active" style=""><?= $i ?></span>
                            <?php else: ?>
                                <a href="?page=<?= $i ?>"><?= $i ?></a>
                            <?php endif; ?>
                        <?php endfor; ?>
