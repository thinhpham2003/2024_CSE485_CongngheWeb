...
<div class="container_fluid">
    ...
    <main>
        ...
        <button class="buttonFunction" onclick=window.location.href='employees_edit.php'>Sửa</button>
        <button class="buttonFunction" onclick=window.location.href='employees_delete.php'>Xoá</button>
        <div class="container-fluid">
